...
struct DareView: View {
    let questionArray = [ "If you have ever had a friend with benefits", "If you have ever had sex in a car", "If you have ever had sex on the first date"]
    @EnvironmentObject var questionManager: QuestionManager
    @Binding var showing: Bool
    var body: some View{
        Image("darecrop")
